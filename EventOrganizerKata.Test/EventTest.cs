...
namespace EventOrganizerKata.Test
{
    public class EventTest
    {
        ...
        [Fact]
        public void GetOverlap_StartsTheSameTime_ReturnsOverlap()
        {
            var date11 = new DateTime(2009, 06, 15, 17, 30, 0);
            var date12 = new DateTime(2009, 06, 15, 19, 30, 0);
            var date22 = new DateTime(2009, 06, 15, 18, 30, 0);
            var event1 = new Event("A", date11, date12);
            var event2 = new Event("B", date11, date22);
        ...
        [Fact]
        public void GetOverlap_EndsTheSameTime_ReturnsOverlap()
        {
            var date11 = new DateTime(2009, 06, 15, 17, 30, 0);
            var date12 = new DateTime(2009, 06, 15, 19, 30, 0);
            var date22 = new DateTime(2009, 06, 15, 18, 30, 0);
        ...
        [Fact]
        public void GetOverlap_StartsBeforeAndEndsDuring_ReturnsOverlap()
        {
            var date11 = new DateTime(2009, 06, 15, 17, 30, 0);
            var date12 = new DateTime(2009, 06, 15, 19, 30, 0);
        ...
        [Fact]
        public void GetOverlap_StartsBeforeAndEndsAfter_ReturnsOverlap()
        {
            var date11 = new DateTime(2009, 06, 15, 17, 30, 0);
            var date12 = new DateTime(2009, 06, 15, 20, 30, 0);
            var date21 = new DateTime(2009, 06, 15, 18, 30, 0);
